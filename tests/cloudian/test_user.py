...
class TestUser:
    ...
    def test_list_fail(self):
        list_user_params = {"groupId": "testing", "userType": "all"}
        userlist = user.get_list(data=list_user_params)

        assert None == userlist

    def test_get(self):
        detail_user_param = {"userId": "buatdarilib1", "groupId": "testing"}
        res = user.detail(data=detail_user_param)
        test_data = {
            "userId": "buatdarilib1",
            "userType": "User",
            "fullName": "edit dari lib",
            "emailAddr": "",
            "address1": "",
            "address2": "",
            "city": "",
            ...
            "website": "",
            "active": "true",
            "canonicalUserId": "6df8c1f68af292367e778a47e11182c8",
            "ldapEnabled": False,
        }
        assert test_data == res

    def test_get_fail(self):
        detail_user_param = {"userId": "buatdarilib1s", "groupId": "testing"}
        res = user.detail(data=detail_user_param)
        assert None == res

    def test_create(self):
        delete_user_param = {"userId": "neoobs2", "groupId": "testing"}
    ...
    def test_delete(self):
        ...
        delete_user_param = {"userId": "testdelete1", "groupId": "testing"}
        res = user.delete(data=delete_user_param)
        assert {} == res

    def test_delete_fail(self):
        delete_user_param = {"userId": "testdelete1nouser", "groupId": "testing"}
        res = user.delete(data=delete_user_param)
        assert None == res
