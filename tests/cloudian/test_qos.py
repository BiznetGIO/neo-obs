...
class TestQos:
    def test_get(self):
        list_params = {"groupId": "testing", "userId": "user_483_20973_stage_wjv-1"}
        ...
        test_data = {
            ...
            "qosLimitList": [
                {"type": "STORAGE_QUOTA_KBYTES", "value": 20971520},
                {"type": "REQUEST_RATE_LW", "value": 10},
                {"type": "REQUEST_RATE_LH", "value": 20},
    ...
    def test_get_fail(self):
        list_params = {"groupId": "testing", "userId": "user_483_20973_stage_wjv-12"}
        list_qos = qos.get(data=list_params)
    ...
    def test_delete(self):
        ...
        delete_params = {"userId": "neoobs5", "groupId": "testing"}
        delete_qos = qos.delete(data=delete_params)
        assert {} == delete_qos

    def test_delete_fail(self):
        delete_params = {"userId": "neoobs55", "groupId": "testing"}
        delete_qos = qos.delete(data=delete_params)
