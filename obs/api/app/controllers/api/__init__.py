...
api.add_resource(object_api,"/storage/object/<bucket_name>/<object_name>")
api.add_resource(download_object,"/storage/object/download/<bucket_name>/<object_name>")
api.add_resource(move_object,"/storage/object/move/<bucket_name>/<object_name>")
api.add_resource(copy_object,"/storage/object/copy/<bucket_name>/<object_name>")
