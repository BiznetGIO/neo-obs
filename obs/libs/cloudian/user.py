...
def get_list(data=None, json=None, method="GET"):
    ...
    list_user = requestors.request(
        url=base_url_list, data=data, json=json, method=method
    )
    try:
...
def detail(data=None, json=None, method="GET"):
    get_user = requestors.request(url=base_url, data=data, json=json, method=method)
...
def create(data=None, json=None, method="PUT"):
    create_user = requestors.request(url=base_url, data=data, json=json, method=method)
...
def update(data=None, json=None, method="POST"):
    update_user = requestors.request(url=base_url, data=data, json=json, method=method)
...
def delete(data=None, json=None, method="DELETE"):
    delete_user = requestors.request(url=base_url, data=data, json=json, method=method)
